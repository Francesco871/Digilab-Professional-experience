...
## Switches
set_property PACKAGE_PIN V17 [get_ports sw_eff]
	set_property IOSTANDARD LVCMOS33 [get_ports sw_eff]
set_property PACKAGE_PIN V16 [get_ports sw_ch0]
	set_property IOSTANDARD LVCMOS33 [get_ports sw_ch0]
set_property PACKAGE_PIN w16 [get_ports sw_ch1]
	set_property IOSTANDARD LVCMOS33 [get_ports sw_ch1]
